...
function actionFormatter(value, row, index) {
    ...
    var result = "";
    result += "<button class='btn btn-outline-success btn-sm ch' type='button' onclick=\"ApplyById('" + row + "','" + id + "')\">申请参加</button>";
    //result += "<button class='btn btn-outline-primary btn-sm ch mx-2' type='button' onclick=\"EditViewById('" + row + "','" + id + "')\">创建团队</button>";
    //result += "<button class='btn btn-outline-success btn-sm ch' type='button' onclick=\"DeleteByIds('" + id + "','" + row + "')\">申请参加</button>";
