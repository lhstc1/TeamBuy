...
CREATE TABLE `leader`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `leadername` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '团长名',
...
-- Records of leader
-- ----------------------------
INSERT INTO `leader` VALUES (1, '小欣', '63b77ed96e433f605c772d59dbd2a73');
...
CREATE TABLE `team`  (
  ...
  `sum` int NOT NULL COMMENT '总人数',
  `pfee` double NOT NULL COMMENT '人均费用',
  `tfee` double NOT NULL COMMENT '团费',
  `elsefee` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '追加费用',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of team
-- ----------------------------
INSERT INTO `team` VALUES (201, '海底世界', '小欣', 998, 1, 998, 10, '个人活动费增加120元');
INSERT INTO `team` VALUES (204, '马尔代夫', '小欣', 3200, 1, 3200, 10, '个人团费增加20元');
INSERT INTO `team` VALUES (206, '方特乐园', '小欣', 1050, 4, 262.5, 10, NULL);
INSERT INTO `team` VALUES (207, '动物园', '小欣', 380, 1, 380, 10, '个人团费增加20元');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (101, '小明', 'fc184b504c69e3b2de621ec6f8807524');
INSERT INTO `users` VALUES (102, '小卷', '1b7b76336fa8c51ff7dddb02fd14bae2');
INSERT INTO `users` VALUES (103, '小李', '13e8e0274a1ac1de26877d5a417e0e94');
INSERT INTO `users` VALUES (104, '小壮', 'fd123f9e08d841036710a59bb8bbdde');
INSERT INTO `users` VALUES (105, '小路', '13e8e0274a1ac1de26877d5a417e0e94');
INSERT INTO `users` VALUES (106, '孙明', '41e3b75f7ab02719f0d47c7e314886a0');
